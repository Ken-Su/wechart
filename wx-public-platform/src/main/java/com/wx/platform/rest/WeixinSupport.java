...
import com.wx.platform.message.aes.AesException;
import com.wx.platform.message.aes.WXBizMsgCrypt;
import com.wx.platform.message.req.BaseEvent;
import com.wx.platform.message.req.BaseReq;
import com.wx.platform.message.req.BaseReqMsg;
import com.wx.platform.message.req.EventType;
import com.wx.platform.message.req.ImageReqMsg;
import com.wx.platform.message.req.LinkReqMsg;
import com.wx.platform.message.req.LocationEvent;
import com.wx.platform.message.req.LocationReqMsg;
import com.wx.platform.message.req.MenuEvent;
import com.wx.platform.message.req.QrCodeEvent;
import com.wx.platform.message.req.ReqType;
import com.wx.platform.message.req.ScanCodeEvent;
import com.wx.platform.message.req.SendPicsInfoEvent;
import com.wx.platform.message.req.TemplateMsgEvent;
import com.wx.platform.message.req.TextReqMsg;
import com.wx.platform.message.req.VideoReqMsg;
import com.wx.platform.message.req.VoiceReqMsg;
import com.wx.platform.util.BeanUtil;
import com.wx.platform.util.CollectionUtil;
import com.wx.platform.util.MessageUtil;
import com.wx.platform.util.SignUtil;
...
public abstract class WeixinSupport {
     ...
     * @return 微信消息处理器列表
     */
    protected abstract List<MessageHandle> initMessageHandles();
     ...
     * @return 微信事件处理器列表
     */
    protected abstract List<EventHandle> initEventHandles();
