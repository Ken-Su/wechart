...
import com.wx.platform.api.response.GetArticleSummaryResponse;
import com.wx.platform.api.response.GetArticleTotalResponse;
import com.wx.platform.api.response.GetInterfaceSummaryHourResponse;
import com.wx.platform.api.response.GetInterfaceSummaryResponse;
import com.wx.platform.api.response.GetUpstreamMsgDistMonthResponse;
import com.wx.platform.api.response.GetUpstreamMsgDistResponse;
import com.wx.platform.api.response.GetUpstreamMsgDistWeekResponse;
import com.wx.platform.api.response.GetUpstreamMsgHourResponse;
import com.wx.platform.api.response.GetUpstreamMsgMonthResponse;
import com.wx.platform.api.response.GetUpstreamMsgResponse;
import com.wx.platform.api.response.GetUpstreamMsgWeekResponse;
import com.wx.platform.api.response.GetUserCumulateResponse;
import com.wx.platform.api.response.GetUserReadHourResponse;
import com.wx.platform.api.response.GetUserReadResponse;
import com.wx.platform.api.response.GetUserShareHourResponse;
import com.wx.platform.api.response.GetUserShareResponse;
import com.wx.platform.api.response.GetUserSummaryResponse;
